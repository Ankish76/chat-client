...
export type ChatSubSubscription = { __typename?: 'Subscription', chatSub: { __typename?: 'Chat', id: string, message: string, type: string, createdAt: Date, updatedAt: Date, user: { __typename?: 'User', id: string, name: string, createdAt: Date, updatedAt: Date } } };
